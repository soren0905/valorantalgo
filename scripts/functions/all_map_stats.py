...
def main():
    maps = {
        "ascent": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=5&timespan=90d",
        "bind": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=1&timespan=90d",
        "breeze": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=8&timespan=90d",
        "icebox": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=6&timespan=90d",
        "lotus": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=11&timespan=90d",
        "split": "https://www.vlr.gg/stats/?event_group_id=all&event_id=all&region=all&country=all&min_rounds=0&min_rating=0&agent=all&map_id=3&timespan=90d",
