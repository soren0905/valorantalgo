...
def fetch_all_teams():
    ...
    while has_next_page:
        url = f"{base_url}?limit=50&page={page}&region=na"
...
def save_data_to_json(teams):
    json_path = os.path.abspath('../../../../../data/JSON/all teams/na_teams.json')
...
def save_data_to_csv(teams):
    csv_path = os.path.abspath('../../../../../data/CSV/all teams/na_teams.csv')
