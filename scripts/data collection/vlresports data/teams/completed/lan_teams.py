...
def fetch_all_teams():
    ...
    while has_next_page:
        # Set the region parameter to 'lan' to fetch only Latin America North teams
        url = f"{base_url}?limit=50&page={page}&region=lan"  # Adjust limit to a safe value for pagination
...
def save_data_to_json(teams):
    json_path = os.path.abspath('../../../../../data/JSON/all teams/lan_teams.json')  # Specify file for LAN teams
...
def save_data_to_csv(teams):
    csv_path = os.path.abspath('../../../../../data/CSV/all teams/lan_teams.csv')  # Specify file for LAN teams
