...
def fetch_all_teams():
    ...
    while has_next_page:
        url = f"{base_url}?limit=all&page={page}&region=br"  # Adjusted to fetch teams from BR region
...
def save_data_to_json(teams):
    json_path = os.path.abspath('../../../../../data/JSON/all teams/br_teams.json')  # Adjusted file name for clarity
...
def save_data_to_csv(teams):
    csv_path = os.path.abspath('../../../../../data/CSV/all teams/br_teams.csv')  # Adjusted file name for clarity
